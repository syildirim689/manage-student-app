export default function CourseIcon({className, fill}) {
    return (
        <svg className={className} width="12" height="15" viewBox="0 0 12 15" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
